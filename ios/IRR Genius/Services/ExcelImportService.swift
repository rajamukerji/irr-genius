...
class ExcelImportService {
    ...
    func importExcel(from url: URL, sheetIndex: Int = 0, hasHeaders: Bool = true) async throws -> ImportResult {
    ...
    func importExcelWithSheetSelection(from url: URL, sheetName: String, hasHeaders: Bool = true) async throws -> ImportResult {
    ...
    private func parseXLSXData(_ data: Data, hasHeaders: Bool) throws -> ParsedExcelData {
    ...
    private func parseXLSData(_ data: Data, hasHeaders: Bool) throws -> ParsedExcelData {
        // This is a very basic implementation
